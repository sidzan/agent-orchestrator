...
- `<slug>` — kebab-case short description + Jira key if known (e.g. `{{CONFIG.integrations.jira.projectKey}}-2600-week-calendar`)
- `NNN` for ADRs — zero-padded sequence (001, 002, …). Check `docs/architecture/decisions/` for the next number.

Examples:
- `docs/plans/2026-04-22-1430-prd-{{CONFIG.integrations.jira.projectKey}}-2600-week-calendar.md`
- `docs/plans/2026-04-22-1505-feat-{{CONFIG.integrations.jira.projectKey}}-2600-week-calendar.md`
- `docs/plans/2026-04-22-1612-spec-{{CONFIG.integrations.jira.projectKey}}-2600-week-calendar.md`
- `docs/plans/2026-04-23-0915-bugfix-{{CONFIG.integrations.jira.projectKey}}-2541-duplicate-booking.md`
...
**"Is there an existing Jira ticket? (e.g. `{{CONFIG.integrations.jira.projectKey}}-2600`, or 'no — create one', or 'skip Jira')"**
