...
- Know the demo-be-flyway backend patterns cold: consult `references/` for project-specific handler patterns, DI conventions, migration tooling, and auth policies
