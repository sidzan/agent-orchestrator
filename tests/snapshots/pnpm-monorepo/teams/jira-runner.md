...
LABELS: ai-generated, demo-mono[, ui | api | odata | bug ...]
PIPELINE: <...>
APP: <...>
BRANCH: <...>
WORKTREE: <...>
...
- `OK: ADMIN-2600 pipeline-resumed comment posted`
- `OK: ADMIN-2612 created + ticket-created comment posted`
- `OK: ADMIN-2600 G7 Verify comment posted`
- `FAILED: ADMIN-9999 not found`
- `FAILED: missing BODY`
