...
3. Explore `.` (and equivalents for other apps) to find the closest existing feature
4. **Files to create / modify:** Determined per-feature by reading `references/` or, if absent, the existing code under ..
