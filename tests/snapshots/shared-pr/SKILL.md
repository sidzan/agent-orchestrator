...
- If the user includes the ticket (e.g. "Create PR for DEMO-2067"), use it and proceed.
- If not, ask: `"What is the Jira ticket number? (e.g. DEMO-2067)"` and stop until they provide it.
...
| Setting | Value |
|---|---|
| Jira base URL | `https://demo.atlassian.net` |
| Project key | `DEMO` |
| Target branch | `main` |
...
Build the Jira link: `https://demo.atlassian.net/browse/{key}`
...
Example: `feature/DEMO-2067-filter-chain-logic`
...
[{KEY}](https://demo.atlassian.net/browse/{KEY}) — {summary}
