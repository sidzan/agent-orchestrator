...
Commit the failing tests as a distinct commit (e.g., `test: [{{CONFIG.integrations.jira.projectKey}}-xxxx] add failing contracts for {feature}`). Record the failing-test names in TASK.md "Test Plan".
