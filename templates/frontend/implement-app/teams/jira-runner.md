...
PROJECT_KEY: {{CONFIG.integrations.jira.projectKey}}
...
LABELS: ai-generated, {{CONFIG.project.name}}[, ui | api | odata | bug ...]
PIPELINE: <...>
APP: <...>
BRANCH: <...>
WORKTREE: <...>
...
- `OK: {{CONFIG.integrations.jira.projectKey}}-2600 pipeline-resumed comment posted`
- `OK: {{CONFIG.integrations.jira.projectKey}}-2612 created + ticket-created comment posted`
- `OK: {{CONFIG.integrations.jira.projectKey}}-2600 G7 Verify comment posted`
- `FAILED: {{CONFIG.integrations.jira.projectKey}}-9999 not found`
- `FAILED: missing BODY`
