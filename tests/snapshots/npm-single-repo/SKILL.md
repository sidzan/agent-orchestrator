...
- `<slug>` — kebab-case short description + Jira key if known (e.g. `DEMO-2600-week-calendar`)
- `NNN` for ADRs — zero-padded sequence (001, 002, …). Check `docs/architecture/decisions/` for the next number.

Examples:
- `docs/plans/2026-04-22-1430-prd-DEMO-2600-week-calendar.md`
- `docs/plans/2026-04-22-1505-feat-DEMO-2600-week-calendar.md`
- `docs/plans/2026-04-22-1612-spec-DEMO-2600-week-calendar.md`
- `docs/plans/2026-04-23-0915-bugfix-DEMO-2541-duplicate-booking.md`
...
. (and equivalents) to ground decisions before
...
**"Is there an existing Jira ticket? (e.g. `DEMO-2600`, or 'no — create one', or 'skip Jira')"**
