...
LABELS: ai-generated, demo-be-efcore[, migration | bug ...]
PIPELINE: implement-backend
BRANCH: <...>
WORKTREE: <...>
TASK_MD: <...>
...
- `OK: (jira-disabled)-2600 pipeline-resumed comment posted`
- `OK: (jira-disabled)-2612 created + ticket-created comment posted`
- `OK: (jira-disabled)-2600 G7 Verify comment posted`
- `FAILED: (jira-disabled)-9999 not found`
- `FAILED: missing BODY`
